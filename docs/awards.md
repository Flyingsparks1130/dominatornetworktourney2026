...
- Mejiro Fund displays “worth of skills”: raw skill value at full purchase prices, without hint discounts. It does not claim actual SP spent. Prerequisite tiers count once, purchased inherited uniques count, and the runner's own unique does not. Negative traits are not purchased skills.
