...
The private preview now calculates both metrics automatically, including live refresh. All 24 current R2 exports (240 runner starts) have coverage. The public page still loads only the catalog and index; the estimates and standings are not mounted there.
